  ...
  function DateTimeField() {
    ...
    this.componentWillReceiveProps = function (nextProps) {
      ...
      if (nextProps.inputFormat !== _this.props.inputFormat) {
        ...
        state.inputValue = _this.props.awMoment(nextProps.dateTime, nextProps.format, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).format(nextProps.inputFormat);
      }

      if (nextProps.dateTime !== _this.props.dateTime && _this.props.awMoment(nextProps.dateTime, nextProps.format, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).isValid()) {
        state.viewDate = _this.props.awMoment(nextProps.dateTime, nextProps.format, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).startOf("month");
        state.selectedDate = _this.props.awMoment(nextProps.dateTime, nextProps.format, true).tz(_this.props.locale || _this.props.awMoment.tz.guess());
        state.inputValue = _this.props.awMoment(nextProps.dateTime, nextProps.format, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).format(nextProps.inputFormat ? nextProps.inputFormat : _this.state.inputFormat);
      }
    ...
    this.onChange = function (event) {
      ...
      if (_this.props.awMoment(value, _this.state.inputFormat, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).isValid()) {
        _this.setState({
          selectedDate: _this.props.awMoment(value, _this.state.inputFormat, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()),
          viewDate: _this.props.awMoment(value, _this.state.inputFormat, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).startOf("month")
        });
      }
    ...
    this.getValue = function () {
      return _this.props.awMoment(_this.state.inputValue, _this.props.inputFormat, true).tz(_this.props.locale || _this.props.awMoment.tz.guess()).format(_this.props.format);
    };
